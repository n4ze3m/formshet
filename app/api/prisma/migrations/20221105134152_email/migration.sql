...
INSERT INTO "new_Form" ("accessKey", "createdAt", "id", "name", "publicAccess", "sheetId", "sheetUrl", "updatedAt", "userId") SELECT "accessKey", "createdAt", "id", "name", "publicAccess", "sheetId", "sheetUrl", "updatedAt", "userId" FROM "Form";
DROP TABLE "Form";
